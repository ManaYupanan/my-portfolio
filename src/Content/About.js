    ...
    return (
        <div className="container navbar-expand-lg my-4">
            ...
            <div className="row my-4">
                ...
                <div className="col-sm">
                    <Carditem url="/images/about.jpg" title="Former president of the student club at Business Economics and Comunication. In the year 2019" discription="Business Economics and Comunication " />
                </div>
            </div>
